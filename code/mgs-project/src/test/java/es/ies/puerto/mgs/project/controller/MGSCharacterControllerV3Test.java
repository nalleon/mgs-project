...
import es.ies.puerto.mgs.project.controller.v3.MGSCharacterControllerV3;
...
public class MGSCharacterControllerV3Test extends TestUtilities {

    @Mock
    MGSCharacterService serviceMock;

    @InjectMocks
    MGSCharacterControllerV3 controller;


    @BeforeEach
    public void beforeEach (){
        MockitoAnnotations.openMocks(this);
        controller = new MGSCharacterControllerV3();
