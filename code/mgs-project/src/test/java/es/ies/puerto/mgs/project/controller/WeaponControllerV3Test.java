...
import es.ies.puerto.mgs.project.controller.v3.WeaponControllerV3;
...
public class WeaponControllerV3Test extends TestUtilities {

    @Mock
    WeaponService serviceMock;

    @InjectMocks
    WeaponControllerV3 controller;


    @BeforeEach
    public void beforeEach (){
        MockitoAnnotations.openMocks(this);
        controller = new WeaponControllerV3();
